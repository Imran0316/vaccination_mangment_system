                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="forms/addhospital.php">
                        <span class="sub-item">Add Hospiatl</span>
                      </a>
                    </li>
                    <li>
                      <a href="forms/addhospital.php">
                        <span class="sub-item">show Hospiatl</span>
                      </a>
                    </li>
                  </ul>
                </div>
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Add Hospitals Details here!</h6>
              </div>
              <div class="ms-md-auto py-2 py-md-0">
                <a href="#" class="btn btn-label-info btn-round me-2">Manage</a>
                <a href="forms/addhospital.php" class="btn btn-primary btn-round">Add Hospitals</a>
              </div>
            </div>
            <div class="row">
