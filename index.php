  ...
  <header id="header" class="header sticky-top">
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <a class="cta-btn d-none d-sm-block" href="signup.php">sign up
        </a>
        <a class="cta-btn d-none d-sm-block bg-danger border border-primary" href="logout.php"><i class="fa-solid fa-power-off  "></i>
        </a>
